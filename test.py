...
from spider import MyHTMLParser  # Ensure to use the renamed HTMLParser class
...
class Test(object):
    ...
    def test_contain_static(self):
        ...
        assert contain_static("http://google.com/me.html") is False
    ...
    def test_HTMLParser_handle_starttag(self):
        ...
        parser.url = ""
        parser.urls = []
        with open("view-source_https___gocardless.com.html", "r") as f:
            parser.feed(f.read())
